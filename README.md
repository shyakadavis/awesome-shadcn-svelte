...
| `Product Plate`      | Open-source SvelteKit + Convex starter built with shadcn-svelte, Tailwind CSS v4, auth, billing, AI, tests, and deployment setup.                                                                    | [Link](https://github.com/rodrgds/productplate)     |
