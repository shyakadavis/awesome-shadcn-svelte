...
- [shadcn-svelte-extras](https://github.com/ieedan/shadcn-svelte-extras) - A project extending and adding components to shadcn-svelte. It includes useful components such as the [Phone Input](https://www.shadcn-svelte-extras.com/components/phone-input) and the [IPv4Address Input](https://www.shadcn-svelte-extras.com/components/ipv4address-input).
